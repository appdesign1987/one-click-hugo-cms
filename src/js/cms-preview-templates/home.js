        ...
        <div className="bg-off-white pv4">
          <div className="ph3 mw7 center">
            ...
            <div className="flex-ns mhn2-ns mb3">
              {(entry.getIn(["data", "photos"]) || []).map((photo, i) => <div className="ph2-ns w-50-ns" key={i}>
                <img src={getAsset(photo.get("image"))} alt="" className="center db mb3" style={{width: "500px"}}/>
                <p>{photo.get("text")}</p>
              </div>)}
            </div>

            <div className="tc">
              <a href="#" className="btn raise">Bekijk onze blog!</a>
            </div>
          </div>
        </div>
